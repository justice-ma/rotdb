...
import com.rotdb.model.context.ContextBuilder;
...
public class DamageResult {
    ...
    public DamageResult(int totalMinDamage, int totalMaxDamage, int totalAvgDamage, int totalMinCrit, int totalMaxCrit,
                        int totalAvgCrit, int totalMinNonCrit, int totalMaxNonCrit, int totalAvgNonCrit, int minCoeff, int maxCoeff, List<HitResult> hit) {
