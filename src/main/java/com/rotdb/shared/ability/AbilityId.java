...
import com.rotdb.shared.combat.domain.model.enums.AbilityCooldownGroup;
...
public enum AbilityId {
    ...
    OVERPOWER(MELEE, ULTIMATE, "Overpower", "/ability_icons/overpower.png", AbilityCooldownGroup.OVERPOWER),
    OVERPOWERIGNEOUS(MELEE, ULTIMATE, "Igneous Overpower", "/ability_icons/overpower.png", AbilityCooldownGroup.OVERPOWER),
    ...
    OMNIPOWER(MAGIC, ULTIMATE, "Omnipower", "/ability_icons/omnipower.png", AbilityCooldownGroup.OMNIPOWER),
    OMNIPOWERIGNEOUS(MAGIC, ULTIMATE, "Igneous Omnipower", "/ability_icons/omnipower.png", AbilityCooldownGroup.OMNIPOWER),
    ...
    CORRUPTIONBLAST(MAGIC, ENHANCED, "Corruption Blast", "/ability_icons/corruption-blast.png", AbilityCooldownGroup.CORRUPTION),
    ...
    DEADSHOT(RANGED, ULTIMATE, "Deadshot", "/ability_icons/deadshot.png", AbilityCooldownGroup.DEADSHOT),
    DEADSHOTIGNEOUS(RANGED, ULTIMATE, "Igneous Deadshot", "/ability_icons/deadshot.png", AbilityCooldownGroup.DEADSHOT),
    ...
    CORRUPTIONSHOT(RANGED, ENHANCED, "Corruption Shot", "/ability_icons/corruption-shot.png", AbilityCooldownGroup.CORRUPTION),
    ...
    DEATHSKULLSIGNEOUS(NECROMANCY, ULTIMATE, "Igneous Death Skulls", "/ability_icons/death-skulls.png", AbilityCooldownGroup.DEATH_SKULLS),
    ...
    QUICKSMASH(MELEE, SPECIAL, "Quick Smash", "special_attack_weapon_icons/granite-maul.png", true, false),
    ...
    public AbilityCooldownGroup getAbilityCooldownGroup() {
        return abilityCooldownGroup;
    }
