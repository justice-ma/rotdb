...
public class MagicAbilityFactory {
    ...
    public static AbilityContext asphyxiateTumekens() {
        return new AbilityContext(8,
                List.of(new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 1),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 2),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 3),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 4),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 5),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 6),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 7),
                        new AbilityHitsContext(0.715, 0.845, false, ENHANCED, 8)),
                "Asphyxiate",
                -25,
                35,
                true,
