...
public class MeleeAbilityFactory {
    ...
    public static AbilityContext assault() {
        return new AbilityContext(4,
                List.of(new AbilityHitsContext(1.3, 1.5, false, ENHANCED, 1),
                        new AbilityHitsContext(1.3, 1.5, false, ENHANCED, 3),
                        new AbilityHitsContext(1.3, 1.5, false, ENHANCED, 5),
                        new AbilityHitsContext(1.3, 1.5, false, ENHANCED, 7)),
                "Assault",
                -25,
                10,
                true,
    ...
    public static AbilityContext bloodlustAssault() {
        return new AbilityContext(4,
                List.of(new AbilityHitsContext(1.7, 1.9, false, ENHANCED, 1),
                        new AbilityHitsContext(1.7, 1.9, false, ENHANCED, 3),
                        new AbilityHitsContext(1.7, 1.9, false, ENHANCED, 5),
                        new AbilityHitsContext(1.7, 1.9, false, ENHANCED, 7)),
                "Bloodlust Assault",
                -25,
                10,
                true,
    ...
    public static AbilityContext hurricane() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.35, 1.65, false, ENHANCED, 1),
                        new AbilityHitsContext(1.55, 1.85, false, ENHANCED, 1)),
                "Hurricane",
                -25,
                34,
                false,
    ...
    public static AbilityContext bloodlustHurricane() {
        return new AbilityContext(3,
                List.of(new AbilityHitsContext(1.35, 1.65, false, ENHANCED, 1),
                        new AbilityHitsContext(1.55, 1.85, false, ENHANCED, 1),
                        new AbilityHitsContext(0.75, 0.95, false, ENHANCED, 1)),
                "Bloodlust Hurricane",
                -25,
                34,
                false,
    ...
    public static AbilityContext flurry() {
        return new AbilityContext(8,
                List.of(new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 1),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 2),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 3),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 4),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 5),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 6),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 7),
                        new AbilityHitsContext(0.6, 0.7, false, ENHANCED, 8)),
                "Flurry",
                -25,
                34,
                true,
    ...
    public static AbilityContext slaughter() {
        return new AbilityContext(6,
                List.of(new AbilityHitsContext(0.8, 1, true, ENHANCED, 3),
                        new AbilityHitsContext(0.8, 1, true, ENHANCED, 6),
                        new AbilityHitsContext(0.8, 1, true, ENHANCED, 9),
                        new AbilityHitsContext(0.8, 1, true, ENHANCED, 12),
                        new AbilityHitsContext(0.8, 1, true, ENHANCED, 15),
                        new AbilityHitsContext(0.8, 1, true, ENHANCED, 18)),
                "Slaughter",
                -25,
                0,
                false,
    ...
    public static AbilityContext massacre() {
        return new AbilityContext(7,
                List.of(new AbilityHitsContext(1.1, 1.3, false, ENHANCED, 1),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 5),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 9),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 13),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 17),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 21),
                        new AbilityHitsContext(1, 1, true, ENHANCED, 25)),
                "Massacre",
                -25,
                0,
                false,
