...
public class RangedSpecialAttackFactory {
    ...
    public static AbilityContext twinShot() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(0.55, 0.65, false, ENHANCED, 2),
                        new AbilityHitsContext(0.55, 0.65, false, ENHANCED, 2)),
                "Twin Shot",
                -35,
                0,
                false,
    ...
    public static AbilityContext soulshot() {
        return new AbilityContext(1,
                List.of(new AbilityHitsContext(1, 1.2, false, ENHANCED, 3)),
                "Soulshot",
                -50,
                0,
                false,
    ...
    public static AbilityContext twinFang() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.15, 1.45, false, ENHANCED, 1),
                        new AbilityHitsContext(1.15, 1.45, false, ENHANCED, 1)),
                "Twin Fang",
                -50,
                0,
                false,
    ...
    public static AbilityContext crystalRain() {
        return new AbilityContext(5,
                List.of(new AbilityHitsContext(1.25, 1.55, false, ENHANCED, 3),
    ...
    public static AbilityContext hamstring() {
        return new AbilityContext(1,
                List.of(new AbilityHitsContext(1.5, 1.7, false, ENHANCED, 3)),
                "Hamstring",
                -50,
                0,
                false,
    ...
    public static AbilityContext descentOfDarkness() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.9, 2.3, false, ENHANCED, 2),
                        new AbilityHitsContext(1.9, 2.3, false, ENHANCED, 2)),
                "Descent of Darkness",
                -65,
                0,
                false,
    ...
    public static AbilityContext powershot() {
        return new AbilityContext(1,
                List.of(new AbilityHitsContext(2.1, 2.3, false, ENHANCED, 3)),
                "Powershot",
                -35,
                0,
                false,
    ...
    public static AbilityContext defiance() {
        return new AbilityContext(1,
                List.of(new AbilityHitsContext(2.25, 2.75, false, ENHANCED, 3)),
                "Defiance",
                -40,
                0,
                false,
    ...
    public static AbilityContext phantomStrike() {
        return new AbilityContext(6,
                List.of(new AbilityHitsContext(1.2, 1.4, false, ENHANCED, 3),
                        new AbilityHitsContext(0.3, 0.4, true, ENHANCED, 6),
                        new AbilityHitsContext(0.3, 0.4, true, ENHANCED, 9),
                        new AbilityHitsContext(0.3, 0.4, true, ENHANCED, 12),
                        new AbilityHitsContext(0.3, 0.4, true, ENHANCED, 15),
                        new AbilityHitsContext(0.3, 0.4, true, ENHANCED, 18)),
                "Phantom Strike",
                -50,
                0,
                false,
    ...
    public static AbilityContext aimedShot() {
        return new AbilityContext(1,
                List.of(new AbilityHitsContext(3, 3.6, false, ENHANCED, 4)),
                "Aimed Shot",
                -35,
                0,
                true,
    ...
    public static AbilityContext destructiveShot() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.6, 1.8, false, ENHANCED, 2),
                        new AbilityHitsContext(1.6, 1.8, false, ENHANCED, 2)),
                "Destructive Shot",
                -40,
                0,
                false,
    ...
    public static AbilityContext restorativeShot() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.35, 1.45, false, ENHANCED, 2),
                        new AbilityHitsContext(0.55, 0.65, false, ENHANCED, 2)),
                "Restorative Shot",
                -30,
                0,
    ...
    public static AbilityContext balancedShot() {
        return new AbilityContext(2,
                List.of(new AbilityHitsContext(1.7, 1.9, false, ENHANCED, 2),
                        new AbilityHitsContext(0.55, 0.65, false, ENHANCED, 2)),
                "Balanced Shot",
                -35,
                0,
