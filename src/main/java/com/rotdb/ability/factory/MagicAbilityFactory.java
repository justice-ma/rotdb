...
public class MagicAbilityFactory {
    ...
    public static AbilityContext asphyxiateTumekens() {
        return new AbilityContext(8,
                List.of(new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 1),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 2),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 3),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 4),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 5),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 6),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 7),
                        new AbilityHitsContext(0.825, 0.975, false, THRESHOLD, 8)),
                "Asphyxiate",
                -25,
                35,
                true,
